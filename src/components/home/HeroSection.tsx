  ...
  return (
    <div className="relative h-screen min-h-[600px] bg-gradient-to-r from-gray-600 to-gray-600 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url(https://www.legrom.de/wp-content/uploads/2017/03/1280px-OE-Actionbild-Spulapparat.png)',
      ...
      <div className="container mx-auto px-4 sm:px-6 h-full flex items-center relative z-10">
        <div className="max-w-3xl sm:ml-20 text-left w-full">
          <motion.h1
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, ease: 'easeOut' }}
            className="text-3xl sm:text-4xl lg:text-5xl font-bold text-orange-400 leading-tight mb-6"
          >
          ...
          >
            Precision-engineered components with over four decades of manufacturing excellence, serving
            clients in 50+ countries worldwide.
          </motion.p>
